...
export class SubscriptionsService {
  ...
  async createUpgradeSession(organizationId: string, planId: string, customerEmail: string) {
  ...
  async cancelSubscription(organizationId: string, billingEmail: string, orgName: string) {
    ...
    await this.notifications.sendSubscriptionEvent(billingEmail, orgName, "SUB_CANCELLED", organizationId);
